...
#' @export
well_screen_hydraulic_conductivity <- function(r_s, r_f, slot_area, slot_perimeter, slot_screen_area_ratio, slot_resistance_coef=12, mu=1.308E-3,rho=999.7,g=9.80665,t=10)
{
