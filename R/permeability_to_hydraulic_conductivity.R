...
#' 
#' @param k Intrinsic permeability of the medium (in square metres)
...
#' @seealso \code{\link{hydraulic_conductivity_to_permeability}}
#' @export
permeability_to_hydraulic_conductivity <- function(k,mu=1.308E-3,rho=999.7,g=9.80665,t=10)
{
